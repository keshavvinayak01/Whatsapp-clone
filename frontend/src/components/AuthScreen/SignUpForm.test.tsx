...
describe('SignUpForm', () => {
  ...
  it('enables sign-up button when filled in', async () => {
      ...
      act(() => {
        fireEvent(nameInput, { target : { value : "User name" } });
        fireEvent(usernameInput, { target : { value : "username" } });
        fireEvent(passwordInput, { target : { value : "password" } });
        fireEvent(passwordConfirmInput, { target : { value : "password" } });
      });
